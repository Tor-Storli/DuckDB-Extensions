...
In this repository you will find the code used in my YouTube Tutorial for the DuckDB Community Extension Tutorial Series.
----
### Part-1 http_client

In this video, we will take a look at the community extension called http_client. This DuckDB Community extension is trying to simplify the way you are
calling web API's.I will direct you to where you can get more information about the DuckDB Community Extensions, as well as give you a demonstration on how to use them.<br><br>
YouTube Link:<br><br>
<a href="https://youtu.be/4kYGRwdmU30">
  <img src="https://i9.ytimg.com/vi/4kYGRwdmU30/mqdefault.jpg?v=68f67733&sqp=COiKncgG&rs=AOn4CLCpAFyYjKN-4gavpJtLX58edpjxdA" alt="http_client" width="100" height="75">
</a>[Watch Video](https://youtu.be/4kYGRwdmU30)

----
### Part-2 Geography

In this video we will take a look at the DuckDB Community Extension called Geography.<br><br>
YouTube Link:<br><br>
